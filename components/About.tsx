    ...
    <section id="about" className="py-32 px-6 md:px-12 lg:px-24 bg-white relative">
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="flex items-center gap-4 mb-32 border-b border-slate-200 pb-8">
          ...
          <h2 className="text-xs font-bold tracking-[0.3em] uppercase text-slate-900">Stack Status</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
          <div className="lg:col-span-5 relative pl-8 border-l border-accent/40">
            <p className="text-xl md:text-2xl text-slate-500 leading-relaxed font-light">
              We control every <span className="text-accent/90 font-medium">critical layer</span>.<br />
