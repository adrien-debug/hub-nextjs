...
export default function ProjectsComing() {
  return (
    <section className="py-32 px-6 md:px-12 lg:px-24 bg-[#0A0A0A] border-t border-white/5 bg-grain relative overflow-hidden">
      ...
      <div className="absolute top-1/3 left-[-50%] w-[200%] h-[2px] bg-[#5eead4] blur-[2px] opacity-20 animate-flow-x pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="border-t border-white/10">
          <div className="group border-b border-white/5 py-16 flex flex-col lg:flex-row justify-between gap-12 relative">
            ...
            <div className="flex flex-col md:flex-row gap-6 md:gap-12 md:items-baseline mt-4 lg:mt-0">
              ...
              <span className="text-xs font-mono text-[#5eead4]/60 tracking-widest uppercase">{comingProjects[0].cat}</span>
            </div>
            ...
            <div className="max-w-sm lg:text-right flex flex-col justify-end">
              <p className="text-slate-400 font-mono text-[10px] leading-relaxed uppercase">
                Mapping decisions and behavioral patterns. <span className="text-[#5eead4]/80 font-bold">Neural sync active.</span> Data stream encrypted.
              </p>
            </div>
        ...
        <div className="mt-24 flex justify-end">
          <div className="flex items-center gap-2 font-mono text-[10px] text-[#5eead4]/90">
