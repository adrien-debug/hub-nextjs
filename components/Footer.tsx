        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 border-t border-white/10 pt-12 mb-24">
          <div className="md:col-span-4">
            ...
            <p className="text-sm text-slate-400 leading-relaxed max-w-xs font-light">
              Redefining digital infrastructure. Proprietary tech stack from silicon to consensus. Absolute sovereignty.
            </p>
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-4 text-sm text-slate-300">
              <li><a href="#about" className="hover:text-[#5eead4] transition-colors">About</a></li>
              <li><a href="#projects" className="hover:text-[#5eead4] transition-colors">Ventures</a></li>
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-4 text-sm text-slate-300">
              <li><a href="#" className="hover:text-[#5eead4] transition-colors">X / Twitter</a></li>
              <li><a href="#" className="hover:text-[#5eead4] transition-colors">GitHub</a></li>
              <li><a href="#" className="hover:text-[#5eead4] transition-colors">LinkedIn</a></li>
            </ul>
          </div>
        </div>
